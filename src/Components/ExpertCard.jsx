...
//         {/* Specialties List */}
//         <ul className="mt-4 text-sm text-gray-600 text-left list-disc list-inside max-w-[230px] space-y-1">
//           {expert.specialties.map((item, index) => (
...
//         <motion.button
//           whileHover={{ scale: 1.1 }}
//           className="mt-6 bg-gradient-to-r from-green-600 to-emerald-500 text-white font-semibold px-5 py-2 rounded-full shadow-md hover:shadow-lg transition-all duration-300"
//         >
//           Book Session
//         </motion.button>
//       </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        {/* Specialties List with gaps */}
        <ul className="mt-4 text-sm text-gray-600 text-left list-disc list-inside max-w-[230px] space-y-2">
          {expert.specialties.map((item, index) => (
            <li key={index}>{item}</li>
          ))}
        </ul>
