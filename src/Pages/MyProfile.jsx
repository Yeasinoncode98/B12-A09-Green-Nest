    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      <div className="w-full max-w-2xl">
        ...
        >
          ...
          {/* ✅ Profile Avatar + Info Section (UPDATED!) */}
          <div className="relative px-8 -mt-16 mb-6">
            <div className="flex flex-col md:flex-row items-center md:items-end gap-6 text-center md:text-left">
              ...
              <div className="flex-1 pb-2">
                ...
                <p className="text-gray-700 font-semibold text-sm flex items-center gap-2 justify-center md:justify-start">
                  <span className="inline-block w-1.5 h-1.5 bg-blue-500 rounded-full" />
                  <span className="text-blue-700">{user?.email}</span>
                </p>
            ...
            <form onSubmit={handleUpdate} className="space-y-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  disabled={!isEditing}
                  className="w-full px-4 py-3 bg-gray-50 border-2 rounded-xl border-gray-200"
                  placeholder="Enter your display name"
                />
              </div>
              ...
              {isEditing && (
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-xl font-semibold shadow-lg"
                >
                  Update Profile
                </button>
              )}
