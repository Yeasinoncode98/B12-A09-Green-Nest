...
// Assuming you use react-router-dom, Link is necessary if 'a' tags link to routes
...
export default function Home() {
  ...
  return (
    <div className="space-y-16">
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center items-center md:flex gap-3">
            ...
            <Link to="/tips" className="btn btn-outline">
              Care Tips
            </Link>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            {[
              ...
              },
              {
                ...
                description: "Clean & fresh air with natural filters",
              ...
              },
              {
                ...
                description: "Vibrant blooms and stunning flowers",
                shimmer: "bg-red-200",
              },
            ].map((cat, index) => (
              <motion.div
      ...
      {/* ================= NEW: PROMOTIONAL/OFFER SECTION ================= */}
      <motion.section
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="relative p-12 bg-gradient-to-tr from-lime-500 to-green-600 rounded-2xl text-center shadow-2xl overflow-hidden mt-[60px]"
      >
        <div className="absolute top-0 right-0 p-4 text-4xl transform rotate-12 text-white opacity-20">
          🎁
        </div>
        <div className="relative z-10">
          <h3 className="font-extrabold text-4xl text-white mb-2 leading-tight">
            FLASH SALE: 20% OFF ALL ITEMS!
          </h3>
          <p className="text-white text-lg mb-6 max-w-2xl mx-auto opacity-90">
            Limited time offer! Use code **GREEN20** at checkout to refresh your
            home with stunning greenery.
          </p>
          <motion.button
            whileHover={{
              scale: 1.05,
            ...
            className="btn bg-white text-green-700 font-bold hover:bg-gray-100 transition duration-300"
          >
            Shop Now
          </motion.button>
        </div>
