...
//   // Update profile and refresh state - FIXED VERSION
//   const updateUserProfile = async (profile) => {
//     if (auth.currentUser) {
//       await updateProfile(auth.currentUser, profile);
//       await auth.currentUser.reload(); // Force reload from Firebase
//       setUser({ ...auth.currentUser }); // Trigger re-render with fresh data
//     }
//   };
